...
extension Resolver: ExprVisitor {
    func visitAssignExpr(expr: Expr.Assign) throws -> Void {
        try resolve(expr.value)
        resolveLocal(expr, name: expr.name)
    }
    
    func visitBinaryExpr(expr: Expr.Binary) throws -> Void {
        try resolve(expr.left)
        try resolve(expr.right)
    }
    
    func visitCallExpr(expr: Expr.Call) throws -> Void {
    ...
    func visitGetExpr(expr: Expr.Get) throws -> Void {
        try resolve(expr.object)
    }
    
    func visitGroupingExpr(expr: Expr.Grouping) throws -> Void {
        try resolve(expr.expression)
    }
    
    func visitLiteralExpr(expr: Expr.Literal) throws -> Void {}
    
    func visitLogicalExpr(expr: Expr.Logical) throws -> Void {
        try resolve(expr.left)
        try resolve(expr.right)
    }
    
    func visitSetExpr(expr: Expr.Set) throws -> Void {
        try resolve(expr.value)
        try resolve(expr.object)
    }
    
    func visitSuperExpr(expr: Expr.Super) throws -> Void {
    ...
    func visitThisExpr(expr: Expr.This) throws -> Void {
        if currentClass == .NONE {
    ...
    func visitUnaryExpr(expr: Expr.Unary) throws -> Void {
        try resolve(expr.right)
    }
    
    func visitVariableExpr(expr: Expr.Variable) -> Void {
